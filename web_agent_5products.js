...
const search = new SerpApi.GoogleSearch("6ead1b90607841a0b14f2ed56dc6be16173e19a2927eb3bd70038ed68d26c0ae");
...
// async function generateProductSuggestions(nicheName) {
//     const promptTemplate = `Generate a concise list of popular product names in the ${nicheName} niche. Please focus solely on providing unique and trendy product names that are currently trending in this market.`;
...
//                     break; // Exit the loop after 5 successful runs
//                 }
//             } else {
